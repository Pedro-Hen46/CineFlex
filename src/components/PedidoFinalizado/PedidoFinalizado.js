...
export default function PedidoFinalizado({ resume, comprador, cpf, ingresso }) {
            ...
            {resume === undefined ? ''
                : <>
                    ...
                    <div className='info-pedido'>
                        <h2>Ingressos</h2>
                        <div>
                            {ingresso.map((value, index) => <h3 className='Numeros-ingressos' key={index}> {value[value.length-1]}   </h3>)}
                        </div>
                    </div>
                    <div className='info-pedido'>
                        <h2>Comprador</h2>
